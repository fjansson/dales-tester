...
FC=mpifrtpx CC=mpifccpx cmake ../dales -DCMAKE_BUILD_TYPE=Debug -DENABLE_FP32_FIELDS=True  -DENABLE_FP32_POIS=True   -DCMAKE_Fortran_FLAGS="-L/vol0004/apps/oss/spack-v1.0.1/opt/spack/linux-a64fx/hdf5-1.14.6-mngsrojzjw54lchhyi4d3ujre3r55yef/lib -lhdf5 -lhdf5_hl"
